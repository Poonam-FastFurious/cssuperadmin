                                                                              ...
                                                                              <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                                                                    <div class="swiper-wrapper">
                                                                                          <div class="swiper-slide">
                                                                                                <img src="https://themesbrand.com/velzon/html/master/assets/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                                                                          </div>
                                                                              ...
                                                                              <div class="d-flex">
                                                                                    <div class="flex-grow-1">
                                                                                          ...
                                                                                          <div class="hstack gap-3 flex-wrap">
                                                                                                <div><Link to="#" class="text-primary d-block"> </Link></div>
                                                                                                <div class="vr"></div>
                                                                                    ...
                                                                                    <div class="flex-shrink-0">
                                                                                          <div>
                                                                                                <Link to="apps-ecommerce-add-product.html" class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="ri-pencil-fill align-bottom"></i></Link>
                                                                                          </div>
                                                                                    </div>
                                                                              </div>
                                                                              ...
                                                                              <div class="product-content mt-5">
                                                                                    ...
                                                                                    <nav>
                                                                                          <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab" role="tablist">
                                                                                                <li class="nav-item">
                                                                                                      <Link class="nav-link active" id="nav-speci-tab" data-bs-toggle="tab" to="#nav-speci" role="tab" aria-controls="nav-speci" aria-selected="true">Specification</Link>
                                                                                                </li>
                                                                                                <li class="nav-item">
                                                                                                      <Link class="nav-link" id="nav-detail-tab" data-bs-toggle="tab" to="#nav-detail" role="tab" aria-controls="nav-detail" aria-selected="false">Details</Link>
                                                                                                </li>
                                                                                          </ul>
                                                                                    </nav>
                                                                                    ...
                                                                                    <div class="row gy-4 gx-0">
                                                                                          ...
                                                                                          <div class="col-lg-8">
                                                                                                <div class="ps-lg-4">
                                                                                                      ...
                                                                                                      <div class="me-lg-n3 pe-lg-4" data-simplebar="" style={{ "maxHeight": "225px" }}>
                                                                                                                        ...
                                                                                                                        <div class="border border-dashed rounded p-3">
                                                                                                                              ...
                                                                                                                              <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                                                                                    <Link to="#" class="d-block">
                                                                                                                                          <img src="https://themesbrand.com/velzon/html/master/assets/images/small/img-12.jpg" alt="" class="avatar-sm rounded object-fit-cover" />
                                                                                                                                    </Link>
                                                                                                                                    <Link to="#" class="d-block">
                                                                                                                                          <img src="https://themesbrand.com/velzon/html/master/assets/images/small/img-11.jpg" alt="" class="avatar-sm rounded object-fit-cover" />
                                                                                                                                    </Link>
                                                                                                                                    <Link to="#" class="d-block">
                                                                                                                                          <img src="https://themesbrand.com/velzon/html/master/assets/images/small/img-10.jpg" alt="" class="avatar-sm rounded object-fit-cover" />
                                                                                                                                    </Link>
                                                                                                                              </div>
